            ...
            try {
                ...
                switch (type) {
                    ...
                    case "Email":
                        ...
                        break;
                    case "PAN":
                        sqlString = "select customer_id as ID, customer_name as NAME, CONCAT(customer_address1,', ',customer_address2,', ',customer_address3,', ',customer_landmark,', ',customer_city,', ',customer_state,', ',customer_country,', ',customer_pin) as ADDRESS, customer_phone as PHONE, customer_mobile as MOBILE, customer_email as EMAIL, customer_website as WEBSITE, customer_gstin as GSTIN, customer_pan as PAN from customer  where customer_pan LIKE '%" + text + "%' order by customer_id";
                        break;
                    case "GSTIN":
                        sqlString = "select customer_id as ID, customer_name as NAME, CONCAT(customer_address1,', ',customer_address2,', ',customer_address3,', ',customer_landmark,', ',customer_city,', ',customer_state,', ',customer_country,', ',customer_pin) as ADDRESS, customer_phone as PHONE, customer_mobile as MOBILE, customer_email as EMAIL, customer_website as WEBSITE, customer_gstin as GSTIN, customer_pan as PAN from customer  where customer_gstin LIKE '%" + text + "%' order by customer_id";
                        break;
                    case "City":
        ...
        <div id="HTMLtoPDF">
            ...
            <table width="90%" align="center" border="0" cellpadding="3">
                ...
                <tr bgcolor="D4FCEE">
                    ...
                    <td><a href="customer_edit_view.jsp?ID=<%=rs.getString("ID").toString()%>"/><img src="images\edit.png" height='20' width='20'/></a></td>
