            ...
            try {
                ...
                switch (type) {
                    ...
                    case "Email":
                        ...
                        break;
                    case "PAN":
                        sqlString = "select consignee_id as ID, consignee_name as NAME, CONCAT(consignee_address1,', ',consignee_address2,', ',consignee_address3,', ',consignee_landmark,', ',consignee_city,', ',consignee_state,', ',consignee_country,', ',consignee_pin) as ADDRESS, consignee_phone as PHONE, consignee_mobile as MOBILE, consignee_email as EMAIL, consignee_website as WEBSITE, consignee_gstin as GSTIN, consignee_pan as PAN from consignee  where consignee_pan LIKE '%" + text + "%' order by consignee_id";
                        break;
                    case "GSTIN":
                        sqlString = "select consignee_id as ID, consignee_name as NAME, CONCAT(consignee_address1,', ',consignee_address2,', ',consignee_address3,', ',consignee_landmark,', ',consignee_city,', ',consignee_state,', ',consignee_country,', ',consignee_pin) as ADDRESS, consignee_phone as PHONE, consignee_mobile as MOBILE, consignee_email as EMAIL, consignee_website as WEBSITE, consignee_gstin as GSTIN, consignee_pan as PAN from consignee  where consignee_gstin LIKE '%" + text + "%' order by consignee_id";
                        break;
                    case "City":
        ...
        <div id="HTMLtoPDF">
            ...
            <table width="90%" align="center" border="0" cellpadding="3">
                ...
                <tr bgcolor="D4FCEE">
                    ...
                    <td><a href="consignee_edit_view.jsp?ID=<%=rs.getString("ID").toString()%>"/><img src="images\edit.png" height='20' width='20'/></a></td>
